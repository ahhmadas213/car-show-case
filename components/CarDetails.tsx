      ...
      <Transition appear show={isOpen} as={Fragment}>
        <Dialog as="div" className="relative z-10" onClose={closeModal}>
          ...
          <div className='fixed inset-0 overflow-y-auto'>
            <div className='flex   iteme-center justify-center p-4 text-center'>
              <Transition.Child
                as={Fragment}
                enter='ease-out duration-300 '
                ...
                rounded-2xl bg-white text-left shadow-xsl transition-all flex-col gap-5">
                  <button
                    type="button"
                    onClick={closeModal}
                    className='absolute top-2 right-2 z-10 w-fit p-2 
                    bg-primmary-blue-100 bg-primary-blue-100 rounded-full'
                  >
                    <Image
                      src="/close.svg"
                      alt='close'
